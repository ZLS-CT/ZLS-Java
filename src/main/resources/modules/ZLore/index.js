import { GetJavaClass, isLegacy, getItemStackLore, getCustomDataNBT, getItemStack, JSONLog } from "../ZCore"
import { splitText } from "../ZRenderLib"
...
function loadLoreActions(itemStack) {
    ...
    // !![GetTooltipMixin] Error: {"message":"Cannot find function #getKeys in object {\"ZLS:append:-1:Timestamp: Jun. 6, 2025, 12:38 PM::0\":{action:\"append\",contentToReplace:\"\",lineIndex:-1,moduleName:\"ZLS\",newContent:\"Timestamp: Jun. 6, 2025, 12:38 PM\",priority:0},\"ZLS:removeAndInsertRegexU:1:Color: #2BADD6:/(?:- |Hex: )\\\\#2BADD6\\\\)/i:10\":{action:\"removeAndInsertRegexU\",contentToReplace:\"/(?:- |Hex: )\\\\#2BADD6\\\\)/i\",lineIndex:1,moduleName:\"ZLS\",newContent:\"Color: #2BADD6\",priority:10}}.","fileName":"file:/C:/Users/jerem/AppData/Roaming/ModrinthApp/profiles/Test%20ZLS%2026.2/config/ZJS/modules/ZLore/index.js","lineNumber":608}
